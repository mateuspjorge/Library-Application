package br.com.locationServer.config;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
          .select()
          .apis(RequestHandlerSelectors.basePackage("br.com.locationServer.controllers"))
	...
	private StringBuilder buildDescription() {
		...
		text.append("Neste exemplo do servidor de localização estão sendo utilizados Spring e swagger");
		return text;
	}
